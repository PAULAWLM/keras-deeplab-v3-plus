...
prediction =  #The path of predicted image
crop_height = 256
crop_width = 256
...
for eval_cls in evaluated_classes:
    ...
    print('{cls:}: {Precision:.4f}'.format(cls=eval_cls, iou=class_p[eval_cls]))
...
for eval_cls in evaluated_classes:
    ...
    print('{cls:}: {Sensitivity:.4f}'.format(cls=eval_cls, iou=class_sn[eval_cls]))